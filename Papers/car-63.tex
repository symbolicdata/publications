...
%\date{Version of September 9, 2018}
...
\Ueberschrift{Introduction}{sec1}
...
\Ueberschrift{Research Data in Science}{sec2}
...
\Ueberschrift{Testing and Benchmarking in Modern Software Engineering}{sec3}
...
\Ueberschrift{Semantic Technologies}{sec4}
...
\Ueberschrift{Semantic Aware Fingerprints}{sec5}
...
\Ueberschrift{Research Infrastructure as a Social Project}{sec6}
...
\Ueberschrift{Acknowledgement}{sec9}
...
% Fix heading of thebibliography
...
\bibitem{polymake} E. Gawrilow, M. Joswig. \newblock Polymake: a Framework for
...
\bibitem{cca-16} A. Heinle, W. Koepf, W. Sperber. \newblock Some steps to
  ...
  pp. 1--11.
\bibitem{heinle-web} A. Heinle: Benchmarks created using SDEval. \newblock
  \url{https://cs.uwaterloo.ca/~aheinle/software_projects.html} [2018-09-07]
\bibitem{MalleKlueners} J. Kl\"uners, G. Malle. \newblock A Database for Number
...
\bibitem{sagemath} The SageMath Project. \newblock
